 ...
 *
 * `runtimes/java/build.gradle.kts` UND `apps/intellij/build.gradle.kts` lesen
 * die Version direkt aus dieser Datei via
 * `rootDir.parentFile.parentFile.resolve("VERSION")` — kein zweiter Schreibort,
 * daher keine Gradle-Sonderbehandlung im Skript nötig.
 *
 * Verwendung:
